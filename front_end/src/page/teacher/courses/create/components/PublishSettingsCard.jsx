    ...
    <section className="teacher-create-card teacher-publish-settings">
      ...
      <div className="teacher-radio-group">
        ...
        {[
          ...
          <label key={value} className={status === value ? "teacher-radio-card teacher-radio-card--active" : "teacher-radio-card"}>
      ...
      <div className="teacher-radio-group">
        ...
        {[
          ...
          <label key={value} className={visibility === value ? "teacher-radio-card teacher-radio-card--active" : "teacher-radio-card"}>
